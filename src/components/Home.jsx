...
export default function Home() {
    ...
    return (
        <div className='home'>
            <h1 className='text-center mt-5'>Welcome to Tic-Tac-Toe Game</h1>
            <div className="home-buttons d-flex justify-content-center align-items-center h-100 flex-column gap-3">
